    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                //Brancas
                for (int i = 0; i < 8; i++) tabuleiro.PosicionarPeca(new Peao(tabuleiro, Cor.Preta), new Posicao(1, i));
                ...
                //Pretas
                for (int i = 0; i < 8; i++) tabuleiro.PosicionarPeca(new Peao(tabuleiro, Cor.Branca), new Posicao(6, i));
